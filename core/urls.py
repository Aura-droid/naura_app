...
urlpatterns = [
    ...
    path('schools/<slug:school_slug>/entry/', take_attendance, name='school_take_attendance'),
    path('schools/<slug:school_slug>/dashboard/', master_dashboard, name='school_master_dashboard'),
    path('schools/<slug:school_slug>/export-pdf/', export_attendance_pdf, name='school_export_attendance_pdf'),
    path('schools/<slug:school_slug>/tod-report/', views.submit_tod_report, name='school_submit_tod_report'),
    path('schools/<slug:school_slug>/export-pdf/<int:report_id>/', views.export_tod_pdf, name='school_export_tod_pdf'),
    path('schools/<slug:school_slug>/export-weekly-pdf/', views.export_weekly_tod_summary, name='school_export_weekly_tod_summary'),
    path('schools/<slug:school_slug>/export-weekly-truants-pdf/', views.export_weekly_truants_pdf, name='school_export_weekly_truants_pdf'),
    path('schools/<slug:school_slug>/hub/', views.teacher_hub, name='school_teacher_hub'),
    path('schools/<slug:school_slug>/hub/results/', views.teacher_result_hub, name='school_teacher_result_hub'),
    path('schools/<slug:school_slug>/hub/results/<int:template_id>/<int:subject_id>/', views.teacher_result_entry, name='school_teacher_result_entry'),
    path('schools/<slug:school_slug>/hub/results/<int:template_id>/<int:subject_id>/autosave/', views.autosave_result_entry, name='school_autosave_result_entry'),
    path('schools/<slug:school_slug>/hub/results/<int:template_id>/<int:subject_id>/analysis/', views.teacher_subject_analysis, name='school_teacher_subject_analysis'),
    path('schools/<slug:school_slug>/hub/results/<int:template_id>/<int:subject_id>/analysis/export/', views.export_teacher_subject_analysis_pdf, name='school_export_teacher_subject_analysis_pdf'),
    path('schools/<slug:school_slug>/results/dashboard/', views.result_template_dashboard, name='school_result_template_dashboard'),
    path('schools/<slug:school_slug>/results/<int:template_id>/', views.result_template_detail, name='school_result_template_detail'),
    path('schools/<slug:school_slug>/results/<int:template_id>/status/', views.update_result_template_status, name='school_update_result_template_status'),
    path('schools/<slug:school_slug>/results/<int:template_id>/export/', views.export_result_template_excel, name='school_export_result_template_excel'),
    path('schools/<slug:school_slug>/results/<int:template_id>/analysis/', views.result_template_analysis, name='school_result_template_analysis'),
    path('schools/<slug:school_slug>/results/<int:template_id>/analysis/export/', views.export_result_template_analysis_pdf, name='school_export_result_template_analysis_pdf'),
    path('schools/<slug:school_slug>/results/<int:template_id>/missing-submissions/', views.export_missing_submissions_report, name='school_export_missing_submissions_report'),
    path('schools/<slug:school_slug>/results/<int:template_id>/delete/', views.delete_result_template, name='school_delete_result_template'),
]
